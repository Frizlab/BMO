...
public extension NSPredicate {
	...
	/* If failForUnknownPredicate is true, the function will gather all the first level predicates it can and ignore any unknown predicates. */
	...
	func expressionByAddingKeyPathPrefix(_ keyPathPrefix: String) -> NSExpression {
		switch expressionType {
			...
			case .aggregate:
				 ...
				 *       In theory it shouldn’t be possible for the collection to contain something else than NSExpressions, but we never know! */
				switch collection {
