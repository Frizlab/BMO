...
public struct ImportResult<Db : DbProtocol> {
	 ...
	 * Furthermore, the bridge metadata info do not really have a place here anyway.
	 *
	 * If we one day absolutely **do** need the metadata directly in the fast import results, it is however possible to do so.
	 * It would be of good taste to name the type of these Metadata “UserInfo” as is in the FastImportRepresentation. */
	...
	/**
	 ...
	 Most of the time will only contain modifications generated by the method, not the implicit modifications
